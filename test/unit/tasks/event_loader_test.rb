...
class Tasks::EventLoaderTest < ActiveSupport::TestCase
  ...
  context :update_events do
    ...
    should 'work' do
      ...
      assert_equal 72, Gnarson.redis.get('test:github:items:2012-01-01').to_i
      assert_equal  3, Gnarson.redis.get('test:github:items:2012-01-01-0').to_i
      assert_equal  3, Gnarson.redis.get('test:github:items:2012-01-01-23').to_i
